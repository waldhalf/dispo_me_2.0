...
<div class="container">
    ...
    <hr>
    <br>
    <p><a href="{{ url ('/posts') }}" type="button" class="btn btn-success rounded inline-block">Liste des métiers</a></p>
    <p><a href="{{ route ('partners.index') }}" type="button" class="btn btn-success rounded">Liste des partenaires</a></p>
    <p><a href="{{ url ('/posts/create') }}" type="button" class="btn btn-success rounded">Créer une fiche métier</a></p>
