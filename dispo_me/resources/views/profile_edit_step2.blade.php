                ...
                <div class="col-md-6">
                    ...
                    <div class="sect">
                        <div class="form-group">
                            ...
                            <input type="text" name="profile_google" class="form-control" id="profile_google"
                                placeholder="Le lien vers vers profil Google (non obligatoire)" value="{{ $profile->profile_google }}">
                    ...
                    <div class="sect">
                        <div class="form-group">
                            ...
                            <input type="text" name="profile_linkedin" class="form-control" id="profile_linkedin" value="{{ $profile->profile_linkedin }}"
                    ...
                    <div class="sect">
                        <div class="form-group">
                            ...
                            <input type="text" name="profile_viadeo" class="form-control" id="profile_viadeo" value="{{ $profile->profile_viadeo }}"
                    ...
                    <div class="sect">
                        <div class="form-group">
                            ...
                            <input type="text" name="profile_facebook" class="form-control" id="profile_facebook" value="{{ $profile->profile_facebook }}"
